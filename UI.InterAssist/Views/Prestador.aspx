<%@ Page Title="" Language="C#" MasterPageFile="~/InterAssist.Master" AutoEventWireup="true" CodeBehind="Prestador.aspx.cs" Inherits="UI.InterAssist.Views.Prestador" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:DataGrid ID="dtgPrestador" runat="server" AllowCustomPaging="True" 
                    AllowPaging="True" AutoGenerateColumns="False" 
                    onitemcommand="dtgPrestador_ItemCommand" 
                    onitemdatabound="dtgPrestador_ItemDataBound" 
                    onpageindexchanged="dtgPrestador_PageIndexChanged" 
                    onselectedindexchanged="dtgPrestador_SelectedIndexChanged" PageSize="20" 
