 ...
 (function($) {
        ...
        $.fn.jTPS = function ( opt ) {
                ...
                $(this).data('tableSettings', $.extend({
                        perPages:                       [5, 6, 10, 20, 50, 'Todos'],                              // the " per page" selection
                        perPageText:            'Registros por página:',                                               // text that appears before perPages links
                        ...
                        scrollDelay:            30,                                                                             // delay (in ms) between steps in anim. - IE has trouble Registros animation with < 30ms delay
                        ...
                        function () {
                                ...
                                $(this).bind('click',
                                        function () {
                                                ...
                                                $('>.nav .status', pT).html( 'Registros ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' de ' + rowCount + '' );
                                                clearSelection();
                                                // callback function after pagination renderd
                                                $(pT).data('tableSettings').clickCallback();
                                        }
                ...
                $('>.nav .status', this).html( 'Registros ' + ( cPos + 1 ) + ' - ' + ( cPos + ePos ) + ' de ' + rowCount );
